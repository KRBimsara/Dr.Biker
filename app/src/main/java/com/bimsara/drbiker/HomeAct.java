    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                fullname.setText(dataSnapshot.child("Full Name").getValue().toString());
                hobby.setText(dataSnapshot.child("Bike Model").getValue().toString());
        ...
        btn_ticket_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotoDetail = new Intent(HomeAct.this, BookingDetailsAct.class);
                gotoDetail.putExtra("jenis_tiket", "sfvsvs");
