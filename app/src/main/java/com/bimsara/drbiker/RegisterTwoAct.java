...
public class RegisterTwoAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        full_name = findViewById(R.id.nama_lengkap);
        bike_model = findViewById(R.id.hobby);
        pic_register_user = findViewById(R.id.pic_registasi_user);
        ...
        btn_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String xnama_lengkap = full_name.getText().toString();
                final String xhobby = bike_model.getText().toString();
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        reference.getRef().child("Full Name").setValue(full_name.getText().toString());
                                        reference.getRef().child("Bike Model").setValue(bike_model.getText().toString());
                                    }
