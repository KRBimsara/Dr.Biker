...
public class BookingCheckoutAct extends AppCompatActivity {
       ...
       final String jenis_tiket_baru = bundle.getString("jenis_tiket");
        ...
        reference2.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                textMyBalance.setText("RS "+ MyBalance +"");
            }
        ...
        btnPlus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                textTotalPrice.setText("RS " +valueTotalPrice+"");
            ...
            public void onClick(View v) {
                ...
                reference3.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Intent gotoSuccessTicket = new Intent(BookingCheckoutAct.this, SuccessBuyTicketAct.class);
